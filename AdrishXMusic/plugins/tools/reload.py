...
from AdrishXMusic.utils.database import get_authuser_names, get_cmode
from AdrishXMusic.utils.decorators import ActualAdminCB, AdminActual, language
from AdrishXMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Adrish.stop_stream(message.chat.id)
    except:
        pass
