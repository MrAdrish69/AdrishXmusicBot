...
from AdrishXMusic import Telegram, YouTube, app
from AdrishXMusic.misc import SUDOERS
from AdrishXMusic.plugins.play.playlist import del_plist_msg
from AdrishXMusic.plugins.sudo.sudoers import sudoers_list
...
from AdrishXMusic.utils.decorators.language import LanguageStart
from AdrishXMusic.utils.inline import help_pannel, private_panel, start_pannel
from AdrishXMusic.utils.command import commandpro
...
@app.on_message(commandpro(["/alive", "Adrish"]) & ~filters.edited)
...
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 Adrish Chat 💮", url=f"https://t.me/Adrish_Support")]]
        ),
    )
